...
namespace ProjectManagementModel
{
    ...
    public partial class ProjectManagementEntities : DbContext
    {
        ...
        public virtual DbSet<Caleadar> Caleadar { get; set; }
        ...
        public virtual DbSet<WorksModified> WorksModified { get; set; }
        public virtual DbSet<PreTasks> PreTasks { get; set; }
        public virtual DbSet<ProjectRelationDept> ProjectRelationDept { get; set; }
    }
}
